...
export const NewsNoticeEdit: React.FC<NewsNoticeEditProps> = ({ id }) => {
    ...
    <div className="p-4 md:p-6 flex flex-col flex-grow relative">
      ...
      {errorMsg ? (
        ...
        <>
          ...
          <div className="mb-6 z-10">
            ...
            <p className="text-xs md:text-sm text-muted-foreground mt-1">
              Modify the announcement details below and save changes.
            </p>
          </div>
        ...
        <div className="flex-grow flex items-center justify-center py-20">
          <span className="text-sm text-muted-foreground">Loading announcement...</span>
        </div>
      )}
    </div>
  );
